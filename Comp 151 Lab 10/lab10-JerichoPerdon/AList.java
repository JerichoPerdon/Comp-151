...
class AList<T> implements ListInterface<T> {
    ...
    */
    public void reverse()
    {
        ...
        //     // Swap the items in the first and last positions
        //     replace(i, getEntry(getLength() - i + 1));

        //     // Swap the items in the second and second to last positions
        //     replace(getLength() - 2, getEntry(getLength() - 2));

        //     // Swap the items in the third and third to last positions
        //     replace(getLength() - 3, getEntry(getLength() - 3));
        ...
        for (int i = 1; i <= getLength() / 2; i++)
        {
            ...
            // i updates with each replacement, so items to be swapped, changes
            replace(i, getEntry(getLength() - i + 1)); 
            
            replace(getLength() - i + 1, swap);
        } // 2nd attempt
    ...
    */
    public void cycle()
    {
        ...
        // Copy each item down one position

        // copy the remembered item to the last position
