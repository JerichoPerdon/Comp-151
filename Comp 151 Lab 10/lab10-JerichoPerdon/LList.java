...
class LList<T> implements ListInterface<T> {
    ...
    */
    ...
    public void reverse() {
        ...
        // Start in the initial state. Use three variables to reference the 
        // first three nodes
        ...
        // Make the first node's next reference be null
        prevNode = null;

        // Make the second node's next reference be the first node. Change
        // all three reference variables so that they move forward by one
        // in the picture
        
        // Make the third node's next reference be the second node. Change
        // all three reference variables so that they move forward by one
        // in the picture

        // Make the fourth node's next reference be the third node

        // Change the variable firstNode so that it references the fourth node
    ...
    public void cycle() {
        ...
        // Start in the initial state. Create a variable that refers to the second
        // node in the list. 
